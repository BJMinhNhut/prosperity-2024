...
class Trader:
    ...
    def update_ema_prices(self, state: TradingState):
        ...
        for product in PRODUCTS:
            ...
            if self.ema_prices[product] is None:
                ...
                self.price_trend[product] = mid_price - \
    ...
    def starfruit_strategy(self, state: TradingState):
        ...
        trend = self.price_trend[STARFRUIT] * 0.25
        ...
        if trend < 0:
            acceptable_bid_price = min(
                acceptable_bid_price, mid_price - trend)
        elif trend > 0:
            acceptable_ask_price = max(
                acceptable_ask_price, mid_price + trend)
